...
echo "🚀 Deploying minimal working SaaS application to Azure..."

# Create ultra-simple requirements
...
# Create simple startup command
echo "python app_minimal.py" > startup.txt

# Package and deploy
echo "📦 Creating minimal deployment package..."
zip -r saas_minimal_deployment.zip \
    app_minimal.py \
...
az webapp deployment source config-zip \
    ...
    --src saas_minimal_deployment.zip
...
curl -s https://ai-event-planner-saas-py.azurewebsites.net/api/health
