#!/bin/bash
# Script to verify if the AI agents are working correctly in the Azure deployment
...
echo "Verifying if the AI agents are working correctly in the Azure deployment..."
...
echo "You can view the logs at: https://ai-event-planner-saas-py.scm.azurewebsites.net/api/logs/docker"
