#!/bin/bash
# Run the AI Event Planner SaaS application in Docker with fixed dependencies

set -e

# Configuration
IMAGE_NAME="ai-event-planner-saas-fixed"
...
docker build -t $IMAGE_NAME -f Dockerfile.saas.fixed.v2 .
