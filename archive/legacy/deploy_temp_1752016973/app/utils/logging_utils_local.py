"""
Logging utilities for the event planning system with optional Azure Application Insights integration.
"""
import os
import logging
import sys
...
try:
    ...
    print("Application Insights not available. Telemetry will be disabled.")
...
def get_telemetry_client() -> Optional[Any]:
    ...
    Returns:
        TelemetryClient instance or None if instrumentation key is not set or AppInsights not available
    """
...
def setup_logger(
    ...
    if enable_app_insights and APPINSIGHTS_AVAILABLE:
...
# Only define AppInsightsHandler if Application Insights is available
