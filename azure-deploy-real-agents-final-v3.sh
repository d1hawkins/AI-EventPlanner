...
# Step 1: Create minimal requirements.txt with only essential packages
print_status "Creating minimal requirements.txt with essential packages..."
...
print_success "Minimal requirements file created"
...
az webapp deployment source config-zip \
    --resource-group "$RESOURCE_GROUP" \
    --name "$APP_NAME" \
    --src real_agents_deployment_v3.zip
